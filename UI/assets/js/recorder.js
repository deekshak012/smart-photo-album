...
var rec=Recorder(); // use the default format, mp3
var date = new Date();
var holder = 'Waiting';
var timeout = false; // start/end button
                ...
                if (data['TranscriptionJob']['TranscriptionJobStatus'] === "COMPLETED") {
                    ...
                    $.getJSON(result_url,
                        function (data) {
                            ...
                            $('#searchImageText').val(sentence);
                            console.log(sentence);
                            timeout = true;
                            holder = "Waiting";
                            $('#searchImageText').attr('placeholder', "Search photo here");
                        });
                }
                else {
                    $('#searchImageText').attr('placeholder', holder);
                    holder = holder + '.';
